                      ...
                      children: [Object(O.jsx)(M.a, {
                          ...
                          children: Object(O.jsxs)(at, {
                              children: [Object(O.jsx)(M.d, {
                                  ...
                                  color: "dataBackground",
                                  children: m - r < 0 ? "Finished" : f > new Date ? "Not Started" : Math.floor((m - r) / 864e5).toLocaleString() + "d " + Math.floor((m - r) / 36e5 % 24).toLocaleString() + "h " + Math.floor((m - r) / 6e4 % 60).toLocaleString() + "m " + Math.floor((m - r) / 3e3 % 60).toLocaleString() + "s"
                              }) : Object(O.jsx)(et.a, {
                                  height: "15px",
                                  width: "100px",
                                  startColor: "gray.400",
